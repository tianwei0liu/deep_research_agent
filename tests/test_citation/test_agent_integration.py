...
_SETTINGS_PATCH = "deep_research_agent.agents.deep_agent.deep_agent._load_settings"
_SEARCH_PATCH = "deep_research_agent.agents.deep_agent.deep_agent._make_internet_search"
_CREATE_PATCH = "deepagents.create_deep_agent"

_FAKE_SETTINGS: dict[str, str] = {
    "tavily_api_key": "fake",
...
class TestBuildDeepAgent:
    ...
    def test_research_worker_has_response_format(
        ...
        from deep_research_agent.agents.deep_agent.deep_agent import build_deep_agent
